...
keyb_main.add("Організації та установи 🏘","Магазини🛍").add("Заклади харчування🍽","Послуги✂️🪡").add("Фінансові та кредитні установи🏦","Краса і здоров'я👗").add("Пошук🔎","Хочеш бути тут❓")
...
butkz1 = types.InlineKeyboardButton(text='Клініки, лабораторії 🏥', callback_data='команда_КлінікиЛабораторії')
...
keyb_kz.add(butkz2).add(butkz1).add(butkz3).add(but_4).add(but_5)
