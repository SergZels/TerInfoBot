...
keyb_main.add("Організації та установи 🏘","Магазини🛍").add("Заклади харчування🍽","Послуги🔧").add("Підприємства🏭","Краса і здоровя👗").add("Фінансові та кредитні установи🏦","Хочеш бути тут❓")
