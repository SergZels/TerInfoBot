...
class BotDataBase(models.Model):
    catlist = [('ГоловаГромади','ГоловаГромади'),('ЗаступникиГолови','ЗаступникиГолови'),
               ...
               ('МагПродуктові','МагПродуктові'),('Супермаркети','Супермаркети'),('МагДитячі','МагДитячі'),('МагГосподарські','МагГосподарські'),('Різне','Різне'),('ОсвітніПослуги','ОсвітніПослуги'),('РитуальніПослуги','РитуальніПослуги'),('ФотоВідео','ФотоВідео'),
               ...
               ('МагКвітиДекор','МагКвітиДекор'),('Подарунки','Подарунки'),('Золото','Золото'),('Телефони','Телефони'),('ПобутоваТехніка','ПобутоваТехніка'),('ОргТехніка','ОргТехніка'),('Канцелярія','Канцелярія'),
               ('ПродажАвто','ПродажАвто'),('СільськаВелосипеди','СільськаВелосипеди'),('ТорговіЦентри','ТорговіЦентри'),
               ('АлкогольТютюн','АлкогольТютюн'),('Універсальнімагазини','Універсальнімагазини'),
